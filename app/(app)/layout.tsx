        ...
        <div className="border-t border-zinc-200/80 bg-white p-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              type="button"
              onClick={logout}
              className="flex items-center justify-center gap-1.5 rounded-xl px-2.5 py-1.5 text-xs font-semibold text-zinc-600 transition-all hover:bg-rose-50 hover:text-rose-600"
              title="Sign out"
            >
              <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
